...
class FineWebEduDataset(IterableDataset):
    def __init__(self, tokenizer: Tokenizer, block_size: int, batch_size: int,
    ...
    def __iter__(self):
        ...
        for example in self.dataset:
            ...
            token_ids = self.tokenizer.encode(text, bos=False, eos=True)
...
if __name__ == "__main__":
    ...
    # Use None for iterable datasets
